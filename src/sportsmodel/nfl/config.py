"""Loaders that read the committed P1/P2 calibration JSONs into config dataclasses.

Each loader reads `assets/nfl/{rating,gameline}.json` (committed, fitted
values) rather than letting the producer fall back to the dataclass defaults
baked into elo.py/gameline.py, which are illustrative-only.
"""
